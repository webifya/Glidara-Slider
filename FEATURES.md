...
This document labels features honestly. “Shipped” means available in 3.0.0. “Foundation” means a useful first implementation exists and will be expanded. “Roadmap” is not advertised as available.
...
- Twelve starter templates, inline editor health feedback and Health Checker 2.0 scoring for alt text, oversized source images, incomplete CTAs, empty slides, long sliders and autoplay controls
...
- WooCommerce featured, sale, best-selling, related and recently viewed sources with complete product-card controls
- Slider and individual-slide scheduling with audience, role, device, URL and query-parameter visibility
- Slider/slide impressions, CTA clicks, CTR, device reporting, ninety-day daily buckets, dashboard, reset and CSV export
- Native Elementor widget for static and dynamic sliders
...
- Variable-width/multi-row carousel, deeper personalization, additional native builder widgets and third-party field integrations
- External analytics events, permissions, multisite and white label
...
- **3.0:** editor health, expanded templates, conversion analytics dashboard and individual-slide scheduling
- **Future:** AI-assisted creation and a provider-backed cloud template library
