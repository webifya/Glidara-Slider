...
final class Glidara_Slider_Plugin {
	...
	public function builder_box( $post ) {
		...
		<div id="glidara-slider-builder" data-next-index="<?php echo esc_attr( count( $slides ) ); ?>">
			...
			<div class="glidara-preview-heading"><div><span class="glidara-eyebrow"><?php esc_html_e( 'Live canvas', 'glidara-slider' ); ?></span><h2><?php esc_html_e( 'Responsive slider preview', 'glidara-slider' ); ?></h2></div><p><?php esc_html_e( 'Scroll the canvas horizontally to inspect every slide. Exact Preview renders the saved frontend output.', 'glidara-slider' ); ?></p></div><div class="glidara-slider-preview-wrap" data-device="desktop"><div class="glidara-slider-preview" aria-live="polite"></div></div>
			</section>
