...
* Added secure extension hooks that let Pro enhance settings, slides and frontend assets without exposing Pro controls in Free.
* Improved Pro interoperability for advanced layer/video JSON data and ensured Pro analytics loads only when a slider renders.
